...
- 📱 **侧边栏面板** - 快速查看和管理手势
- 🔧 **完整的配置选项** - 灵活调整灵敏度和行为
- 🌍 **多语言支持** - 支持英文、简体中文、德语、日语、俄语 5 种语言，自动检测浏览器语言

## 📸 功能展示

### 侧边栏控制面板
快速查看和管理您的鼠标手势设置，支持多语言界面

![侧边栏控制面板](./docs/images/sidepanel-control.png)

### 多语言支持
支持 5 种语言切换：🇬🇧 English | 🇨🇳 简体中文 | 🇩🇪 Deutsch | 🇯🇵 日本語 | 🇷🇺 Русский

![多语言界面](./docs/images/sidepanel-control-i18n.png)

### 页面手势操作
在任意网页中使用鼠标手势，实时显示轨迹效果

![在页面中使用手势](./docs/images/user-gesture-in-page.png)

### 手势配置管理
查看和管理所有预设手势

![手势配置](./docs/images/settings-page-gestures.png)
...
![高级设置](./docs/images/settings-page-custom-settings.png)
...
![手势操作演示](./docs/images/user-gesture-in-page.png)

### 多语言切换
1. 点击扩展图标打开侧边栏或进入选项页面
2. 在页面顶部找到语言选择器
3. 选择您偏好的语言：
   - 🇬🇧 **English** - 英语
...
![多语言界面展示](./docs/images/sidepanel-control-i18n.png)
